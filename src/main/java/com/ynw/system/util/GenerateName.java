...
public class GenerateName {
     ...
     * @return
     */
    private static List<String> makeData(int dataLength) {
        // 写一个百家姓的数组
...
//        List<String> nameList = makeData(1);
...
//    }
    ...
    private String getChineseName() {
        ...
        if(sex==0){
            ...
            length=girl.length();
            name_sex = 1;
            head_image_url = "system/girl.png";
        }else {
            name_sex= 0;
            head_image_url = "system/boy.png";
        }
        ...
        String nickName = first+second+third;
        AcUser user = new AcUser();
     ...
     * @return
     */
    public AcUser getAddress(Integer no) {
        AcUser acUser = new AcUser();
        acUser.setAcUserId(UUIDUtil.getEUUID());
        acUser.setNo(String.valueOf(no));
        acUser.setType(2);
        String name = getChineseName();
        acUser.setNickname(name);
        acUser.setRealName(name);
        acUser.setSex(name_sex);
        acUser.setHeadImageUrl(head_image_url);
        acUser.setPhoneNumber(getTel());
        //为注册用户生成邀请码
        acUser.setReferralCode(UUIDUtil.getBase32ReferralCode(Integer.valueOf(acUser.getNo()),6));
        System.out.println(acUser.getReferralCode());
        acUser.preInsert();
        return acUser;
    }
